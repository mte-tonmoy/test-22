          ...
          <form>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                min="0"
                className="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-sm font-medium text-[#6B7280] outline-none focus:border-green-500 focus:shadow-md"
              />
            </div>
